...
public class AddMealPlan extends javax.swing.JFrame {
    ...
    private void btnAddMealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddMealActionPerformed
        ...
        dbHelper.addMealInfo(mealNumber, selectedItem, mealTitle, mealDescription);

       
        // show success message
        JOptionPane.showMessageDialog(this, "Meal added successfully"); 
        DisplayMealPlan displayMealPlan = new DisplayMealPlan();
        displayMealPlan.setVisible(true);
        dispose();
